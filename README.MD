...
1. __Sensor node(s)__ ([code](SensorNodeE32_01.py))
    ...
    - sensor node 01 has a DHT11 temperature and humidity sensor.
...
1. __Influxdb server__
    ...
    - __table__ : node_01 (each sensor node has it's own table)
